    ...
    <div>
        ...
        <div class="mx-auto mt-10 bg-white shadow">
            <div class="mx-auto md:w-2/3 py-20 px-6">
                <FormKit type="form" submit-label="Guardar Cambios" incomplete-message='Formulario incompleto'
                    @submit="handleSubmit"
                    :value="formData"
                    >

                    <FormKit 
                        type="text" label="Nombre" name="nombre" placeholder="Nombre de cliente"
                    ...
                    <FormKit type="text" label="Email" name="email" placeholder="Email de cliente"
                    ...
                    <FormKit type="text" label="Teléfono" name="telefono" placeholder="Teléfono: XXX-XXX-XXXX"
                        ...
                        :validation-messages="{ matches: 'El formato no es valido' }" validation-visibility="submit" 
